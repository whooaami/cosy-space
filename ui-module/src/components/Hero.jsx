...
function Hero() {
  return (
    <div className="relative w-full flex flex-col">
      <section
        className="relative w-full h-screen bg-fixed overflow-hidden"
        aria-label="Background with space theme"
      >
        <div
          className="absolute inset-0 animate-zoom bg-cover bg-center"
          style={{ backgroundImage: `url(${spaceImage})` }}
        />

        <div className="absolute inset-0 bg-black bg-opacity-70" />

        <div className="relative flex flex-col justify-center items-center text-white z-10 px-4 py-20 h-full text-center">
          <div className="flex flex-col items-center mb-8">
            <img
              src={officeImage}
              alt="Modern office workspace with ergonomic furniture"
              className="w-32 md:w-40 lg:w-48 mb-4"
              data-aos="fade-up"
            />
            ...
            <h1
              ...
              data-aos-delay="300"
            >
              <TypingText text="NEED A PLACE TO WORK?" speed={80} />
            </h1>
          </div>
...
const YellowBox = () => (
  ...
  >
    ...
    <div className="mt-6" data-aos="zoom-in" data-aos-delay="1000">
